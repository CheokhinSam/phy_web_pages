...
function initLorentzForce() {
    ...
    if (ctrlPanel) {
        ...
        bSlider.addEventListener('input', () => { updateParams(); trailPoints = []; });
        mSlider.addEventListener('input', () => { updateParams(); trailPoints = []; });
        qSlider.addEventListener('input', () => { updateParams(); trailPoints = []; });
        vSlider.addEventListener('input', () => { updateParams(); trailPoints = []; });
